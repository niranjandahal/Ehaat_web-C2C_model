...
if (isset($_SESSION['userloggedin']) && $_SESSION['userloggedin'] === 'true') {
    ...
    if ($user_id != null) {
        ...
        //approved product list from users table approveditem column
        $sql1 =  "SELECT approveditem FROM users WHERE id = $user_id";
...
<head>
    ...
    <style>
        ...
        .product-card {
            ...
            /* Darker product card background color */
...
<body>
    ...
    <?php
    // Your PHP code for retrieving and displaying products
    ?>
    <div class="tittle">
    ...
    <section>
        <?php
        // Loop through ordered items and display in product cards
    ...
    <div class="tittle">
        ...
        <!-- text with be patience you will recieve soon -->

        <!-- <p class="confirmedordertext">Be Patience! It might take 3-4 days</p> -->
    </div>
    <section>
        <?php
        // Loop through approved items and display in product cards
